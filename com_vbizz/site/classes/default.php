...
?>
<link href="<?php echo JURI::root() ?>templates/legacyoverland/css/style.css" rel="stylesheet" type="text/css" />
<link href="<?php echo JURI::root() ?>templates/legacyoverland/css/responsive.css" rel="stylesheet" type="text/css" />
<script type="text/javascript">
/* var nameElement = document.forms.myform.mod_rscontact_full_name;
function nameFocus( e ) {
  var element = e.target || window.event.srcElement;
  if ( element.value == "<?php echo JText::_('MOD_RSCONTACT_FULL_NAME');?>" )
    element.value = "";
}
...
function nameBlur(e) {      
  var element = e.target || window.event.srcElement;
  if ( element.value === "" )
    element.value = "<?php echo JText::_('MOD_RSCONTACT_FULL_NAME');?>";
}
...
<div id="mod-rscontact-container-<?php echo $uniqid;?>" class="rscontact">
	...
	<?php } ?>
		...
		<?php } ?>
			<div class="controls">
				<textarea name="mod_rscontact_message" id="mod-rscontact-message-<?php echo $uniqid; ?>" rows="5" class="<?php echo $class;?>" <?php echo $placeholder;?> ></textarea>
			</div>
		</div>
		<?php } ?>
