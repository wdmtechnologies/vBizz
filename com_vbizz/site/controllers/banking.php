...
class VbizzControllerBanking extends VbizzController
{
	...
	function __construct()
	{
		...
		$config = $this->getModel('banking')->getConfig();
	...
	function save()
	{
		...
		if ($model->store($data)) {
			...
			$obj->result='success';
			$obj->msg=JText::_( 'MONEY_TRANSFERRED' );
		}else {
	...
	function cancel($key = NULL)
	{
		...
		$this->setRedirect( JRoute::_('index.php?option=com_vbizz&view=banking') );
	}
	
	//get available_balance in account
