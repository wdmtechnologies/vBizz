...
<header class="header">
	<div class="container-title">
		<h1 class="page-title"><?php echo JText::_('MANAGE_STOCK'); ?></h1>
	</div>
</header>
...
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th class="hidden-phone"><?php echo JHTML::_('grid.sort', 'ISSUE', 's.issue', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
            <th><?php echo JHTML::_('grid.sort', 'PRODUCT', 'i.title', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)	{
		...
		if($row->issue==1) {
			$issue = JText::_('ISSUE_FOR_PRODUCTION');
		} else if($row->issue==2) {
			$issue = JText::_('RECIEVE_FOR_SALES');
		} else if($row->issue==3) {
			$issue = JText::_('RECORD_TRANSFER');
		} else if($row->issue==4) {
			$issue = JText::_('RECORD_WASTAGE');
		}
		...
		<tr class="<?php echo "row$k"; ?>">
            ...
            <td class="hidden-phone"><?php echo $issue; ?></td>
