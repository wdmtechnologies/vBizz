...
<div class="btn-wrapper transfer-money"  id="toolbar-new">
	...
	<span class="fa fa-send"></span> <?php echo JText::_('TRANSFER_MONEY'); ?></span>
</div>
<?php } ?>
...
<div id="editcell">
    <table class="adminlist table">
        <thead>
            <tr>
                ...
                <th><?php echo JHTML::_('grid.sort', 'FROM_ACCOUNT', 'f.account_name', @$this->lists['order_Dir'], @$this->lists['order'] );?></th>
                <th><?php echo JHTML::_('grid.sort', 'TO_ACCOUNT', 't.account_name', @$this->lists['order_Dir'], @$this->lists['order'] );?></th>
                <th><?php echo JHTML::_('grid.sort', 'TRANSFERRED_AMOUNT', 'b.amount', @$this->lists['order_Dir'], @$this->lists['order'] );?></th>
				<th class="hidden-phone"><?php echo JHTML::_('grid.sort', 'TRANSFERRED_BY', 'u.name', @$this->lists['order_Dir'], @$this->lists['order'] );?></th>
				<th class="hidden-phone"><?php echo JHTML::_('grid.sort', 'TRANSFERRED_ON', 'b.created', @$this->lists['order_Dir'], @$this->lists['order'] );?></th>
            </tr>
        </thead>
    <?php
    $k = 0;
    ...
    ?>
        <tr class="<?php echo "row$k"; ?>">
            ...
            <td><?php echo $row->accountFrom; ?></td>
            
            <td><?php echo $row->accountTo; ?></td>
