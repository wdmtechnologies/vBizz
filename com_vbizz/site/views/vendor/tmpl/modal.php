...
$function = $input->getCmd('function', 'getVendVal'); 
...
<form action="index.php?option=com_vbizz&view=vendor&layout=modal&tmpl=component" method="post" name="adminForm" id="adminForm">
...
<table class="adminlist table" width="100%">
    ...
    ?>
    	<tr class="<?php echo "row$k"; ?>">
            ...
            <td align="center">
            	<a href="javascript:void(0)" onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('<?php echo $row->userid; ?>',  '<?php echo $this->escape(addslashes($row->name)); ?>');" id="<?php echo $row->userid;?>"><?php echo $row->name; ?></a>
            </td>
    	</tr>
    <?php
    	$k = 1 - $k;
