...
<script type="text/javascript">
	Joomla.submitbutton = function(task) {
		if (task == 'close') {
			...
			if(form.tid.value == 0)	{
				alert("<?php echo JText::_('PLZ_SELECT_FIELD_FOR_TRANSACTION_TYPE'); ?>");
				return false;
			}
			if(form.mid.value == 0)	{
...
<div class="row-fluid">
    <div class="span12">
        <div class="btn-toolbar" id="toolbar">
            ...
            <span onclick="Joomla.submitbutton('import_now')" class="btn btn-small btn-success">
            <span class="icon-apply icon-white"></span> <?php echo JText::_('IMPORT_NOW'); ?></span>
            </div>
            <?php } ?>
            
            <div class="btn-wrapper"  id="toolbar-cancel">
                <span onclick="Joomla.submitbutton('close')" class="btn btn-small">
                <span class="icon-cancel"></span> <?php echo JText::_('CANCEL'); ?></span>
            </div>
        </div>
    </div>
</div>
...
<table class="adminform table table-striped">
    <tbody>
    <tr>
        <th width="200"><label><?php echo JText::_('TITLE'); ?><?php echo JText::_('<span style="color:Red;">'.'*  '.'</span>');?>:</label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo JText::_('TRANSACTION_DATE'); ?><?php echo JText::_('<span style="color:Red;">'.'*  '.'</span>');?>:</label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo JText::_('AMOUNT'); ?><?php echo JText::_('<span style="color:Red;">'.'*  '.'</span>');?>:</label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo JText::_('DISCOUNT_AMOUNT'); ?></label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo JText::_('TAX_AMOUNT'); ?></label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo JText::_('TYPES'); ?><?php echo JText::_('<span style="color:Red;">'.'*  '.'</span>');?>:</label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo $this->config->type_view_single; ?><?php echo JText::_('<span style="color:Red;">'.'*  '.'</span>');?>:</label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo JText::_('TRANSACTION_MODE'); ?><?php echo JText::_('<span style="color:Red;">'.'*  '.'</span>');?>:</label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo $this->config->customer_view_single; ?></label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo $this->config->vendor_view_single; ?></label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo JText::_('ACCOUNTS'); ?></label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo JText::_('QUANTITY'); ?><?php echo JText::_('<span style="color:Red;">'.'*  '.'</span>');?>:</label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo JText::_('STATUS'); ?></label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo JText::_('TRANSACTION_ID'); ?></label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo JText::_('COMMENTS'); ?></label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo JText::_('CREATED_ON'); ?></label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo JText::_('CREATED_BY'); ?></label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo JText::_('MODIFIED_ON'); ?></label></th>
        <td>
    ...
    <tr>
    	<th><label><?php echo JText::_('MODIFIED_BY'); ?></label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo JText::_('CHECKED_ON'); ?></label></th>
        <td>
    ...
    <tr>
    	<th><label><?php echo JText::_('CHECKED_BY'); ?></label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo $this->config->item_view_single.' '.JText::_('TITLE'); ?><?php echo JText::_('<span style="color:Red;">'.'*  '.'</span>');?>:</label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo $this->config->item_view_single.' '.JText::_('AMOUNT'); ?><?php echo JText::_('<span style="color:Red;">'.'*  '.'</span>');?>:</label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo $this->config->item_view_single.' '.JText::_('DISCOUNT'); ?><?php echo JText::_('<span style="color:Red;">'.'*  '.'</span>');?>:</label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo $this->config->item_view_single.' '.JText::_('TAX'); ?><?php echo JText::_('<span style="color:Red;">'.'*  '.'</span>');?>:</label></th>
        <td>
    ...
    <tr>
        <th><label><?php echo $this->config->item_view_single.' '.JText::_('QUANTITY'); ?><?php echo JText::_('<span style="color:Red;">'.'*  '.'</span>');?>:</label></th>
        <td>
...
<input type="hidden" name="filename" value="<?php echo JRequest::getVar('filename',''); ?>" />
