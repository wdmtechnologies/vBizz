...
Joomla.submitbutton = function(task) {
	if (task == 'cancel') {
		...
		if(form.title.value == "")	{
			alert("<?php echo JText::_('ENTER_DESG_TITLE'); ?>");
			return false;
		}
...
<header class="header">
	<div class="container-title">
		<h1 class="page-title"><?php echo isset($this->edesg->id)&&$this->edesg->id>0?JText::_('EMDSEDIT'):JText::_('EMDSNEW'); ?></h1>
	</div>
</header>
...
<fieldset class="adminform">
	...
	<ul>
		<li><?php	echo JText::_('NEW_EDESG_OVERVIEW');  ?></li>
	</ul>
</fieldset>
</div>
...
<div class="col100">
<fieldset class="adminform">
<legend><?php if($this->edesg->id) echo JText::_('DETAILS'); else echo JText::_('ADD_NEW'); ?></legend>
<table class="adminform table table-striped">
    <tbody>
    
    <tr>
        <th width="200">
        	<label class="hasTip" title="<?php echo JText::_('EMPDESGNAMETXT'); ?>">
        	<?php echo JText::_('DESG_NAME'); ?><?php echo JText::_('<span style="color:Red;">'.'*  '.'</span>');?></label>
        </th>
    	<td><input class="text_area" type="text" name="title" id="title" value="<?php echo $this->edesg->title;?>"/></td>
    </tr>
    
	<tr>
        <th><label class="hasTip" title="<?php echo JText::_('STATUSTXT');?>"><?php echo JText::_('PUBLISHED');?></label></th>
        <td>
            <fieldset class="radio_button btn-group">
            <label for="published1" id="published-lbl" class="radio btn"><?php echo JText::_( 'YS' ); ?></label>
            <input type="radio" name="published" id="published1" value="1" <?php if($this->edesg->published) echo 'checked="checked"';?>/>
            <label for="published0" id="published-lbl" class="radio btn"><?php echo JText::_( 'NOS' ); ?></label>
            <input type="radio" name="published" id="published0" value="0" <?php if(!$this->edesg->published) echo 'checked="checked"';?>/>
            </fieldset>
        </td>
    </tr>
	...
	<tr>
            ...
            <td><textarea class="text_area" name="description" id="description" rows="4" cols="50"><?php echo $this->edesg->description;?></textarea></td>
        </tr>
...
<input type="hidden" name="id" value="<?php echo $this->edesg->id; ?>" />
