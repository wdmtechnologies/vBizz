...
$function = $input->getCmd('function', 'getDesg'); 
...
<form action="<?php echo JRoute::_('index.php?option=com_vbizz&view=edesg&layout=modal&tmpl=component'); ?>" method="post" name="adminForm" id="adminForm">
...
<table class="adminlist table" width="100%">
    ...
    ?>
    	<tr class="<?php echo "row$k"; ?>">
            ...
            <td align="center">
            	<a href="javascript:void(0)" onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('<?php echo $row->id; ?>',  '<?php echo $this->escape(addslashes($row->title)); ?>');" id="<?php echo $row->id;?>"><?php echo $row->title; ?></a>
            </td>
    	</tr>
    <?php
    	$k = 1 - $k;
