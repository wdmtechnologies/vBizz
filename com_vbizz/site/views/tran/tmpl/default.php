...
<header class="header">
	<div class="container-title">
		<h1 class="page-title"><?php echo $this->config->type_view; ?></h1>
	</div>
</header>
            ...
            <div class="span12">
                <div id="toolbar" class="btn-toolbar">
                        ...
                        <div class="btn-wrapper"  id="toolbar-new">
                            ...
                            <span class="fa fa-check"></span> <?php echo JText::_('NEW'); ?></span>
                        </div>
                         <?php } ?>
...
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th><?php echo JHTML::_('grid.sort', 'TITLE', 'a.title', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
            <th class="hidden-phone"><?php echo JHTML::_('grid.sort', 'BUDGET', 'a.budget', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)	{
		...
		$link 		= JRoute::_( 'index.php?option=com_vbizz&view=tran&task=edit&cid[]='. $row->id );
		...
		<tr class="<?php echo "row$k"; ?>">
            ...
            <td class="hidden-phone"><?php echo $budget; ?></td>
