...
//check acl for add,edit,delete access
$add_access = $this->config->expense_acl->get('addaccess');
$edit_access = $this->config->expense_acl->get('editaccess');
$delete_access = $this->config->expense_acl->get('deleteaccess');
...
<header class="header">
	<div class="container-title">
		<h1 class="page-title"><?php echo JText::_('EXPENSE'); ?></h1>
	</div>
</header>
<div class="content_part">
<form action="<?php echo JRoute::_('index.php?option=com_vbizz&view=expense'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <div class="row-fluid">
            <div class="span12">
                <div id="toolbar" class="btn-toolbar">
                    ...
                    <span class="fa fa-plus"></span> <?php echo JText::_('CSV_EXPORT'); ?></a>
                    </div>
...
<div class="filter_right">
	...
	<div class="status">  
	<?php echo $this->lists['modes']; ?>
	</div>
	<div class="status">
	<?php echo $this->lists['ttypes']; ?>
	</div>
</div>
</div>
...
<div id="editcell">
	...
	<thead>
		<tr>
            ...
            <?php /*?><th><?php echo JHTML::_('grid.sort', 'QUANTITY', 'i.quantity', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th><?php */?>
            ...
            <?php /*?><th><?php echo JHTML::_('grid.sort', 'ACTUAL_AMOUNT', 'i.actual_amount', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th><?php */?>
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)	{
		...
		$link 		= JRoute::_( 'index.php?option=com_vbizz&view=expense&task=edit&cid[]='.$row->id,false);	
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td align="center">
            	<?php 
				if ($row->checked_out) : 
					echo JHtml::_('jgrid.checkedout', $i, $row->title, $row->checked_out_time, '', true);
					 endif; 
            ...
            <?php /*?><td align="center"><?php  echo'<span style="color:#FF0000;">'.$row->actual_amount.'</span>'; ?></td><?php */?>
          ...
          $itemName = strtolower($itemTitle); ?>
			...
			<span class="print_receipt">
			 <a href="<?php echo JURI::root().'index.php?option=com_vbizz&view=expense&task=print_bill&tmpl=component&cid[]='.$row->id; ?>" class="pdf modal btn"><i class="fa fa-print"></i></a>
			 </span> 
             <?php if(isset($this->config->enable_vendor) && $this->config->enable_cust==1){ ?> 			 
