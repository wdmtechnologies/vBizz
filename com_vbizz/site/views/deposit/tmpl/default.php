...
<header class="header">
	<div class="container-title">
		<h1 class="page-title"><?php echo JText::_('DEPOSITS'); ?></h1>
	</div>
</header>
    ...
    <table class="adminlist table">
        <thead>
            <tr>
				...
				<th class="hidden-phone"><?php echo JHTML::_('grid.sort', 'DEPOSITED_BY', 'u.name', @$this->lists['order_Dir'], @$this->lists['order'] );?></th>
				<th class="hidden-phone"><?php echo JHTML::_('grid.sort', 'DEPOSITED_ON', 'd.created', @$this->lists['order_Dir'], @$this->lists['order'] );?></th>
            </tr>
        </thead>
    <?php
    $k = 0;
