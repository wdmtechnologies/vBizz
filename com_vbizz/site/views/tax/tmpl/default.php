...
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th><?php echo JHTML::_('grid.sort', 'TAX_NAME', 'tax_name', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
            <th><?php echo JHTML::_('grid.sort', 'TAX_VALUE', 'tax_value', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
		</tr>
	</thead>
	<?php
	$k = 0;
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)	{
		...
		$link 		= JRoute::_( 'index.php?option=com_vbizz&view=tax&task=edit&cid[]='. $row->id );
		?>
		<tr class="<?php echo "row$k"; ?>">
            ...
            <td align="center"><?php echo $row->tax_value; ?></td>
