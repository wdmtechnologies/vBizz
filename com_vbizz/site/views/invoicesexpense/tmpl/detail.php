...
function refreshDashboard() {
        ...
        var jqxhr = jQuery.ajax({
			...
			dataType: "json",
            url: "index.php",
             data: {"option":"com_vbizz", "view":"invoicesexpense", "task":"UpdateComments", "section":"invoicesexpense", "ptaskid":"<?php echo (int)$this->invoices->id; ?>", "tmpl":"component", "<?php echo JSession::getFormToken(); ?>":1, 'abase':1}
        }).done(function(resp){
            console.log('REFRESH');
...
<form action="<?php echo JRoute::_('index.php?option=com_vbizz&view=invoicesexpense&layout=detail&tmpl=component&cid[]='.$this->invoices->id.'&projectid='.$projectid); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
