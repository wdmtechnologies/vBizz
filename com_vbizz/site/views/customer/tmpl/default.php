...
//echo'<pre>';print_r($groups);print_r($add_access);
...
<header class="header">
	<div class="container-title">
		<h1 class="page-title"><?php echo $this->config->customer_view; ?></h1>
	</div>
</header>
<div class="content_part">
<form action="<?php echo JRoute::_('index.php?option=com_vbizz&view=customer');?>" method="post" name="adminForm" id="adminForm">
...
<table class="adminlist table">
    ...
    for ($i=0, $n=count( $this->items ); $i < $n; $i++)	{
		...
		$link 		= JRoute::_( 'index.php?option=com_vbizz&view=customer&task=edit&cid[]='.$row->userid );
		$linkEid 	= JRoute::_( 'index.php?option=com_vbizz&view=income&eid='.$row->userid );
    ...
    ?>
    	<tr class="<?php echo "row$k"; ?>">
            ...
            <td align="center"><a href="<?php echo $linkEid; ?>"><?php if($total_amount) echo $this->config->currency.' '.$total_amount; else echo ''; ?></td>
			
            <td align="center" class="send_email hidden-phone"><a class="btn" href="javascript:void(0);" onclick="customeremail(<?php echo $row->userid; ?>);" class="send_mail" custid="<?php echo $row->userid; ?>"><?php echo JText::_('SEND_EMAIL'); ?></td>
	...
	<table class="adminform table table-striped">
		<tbody id="mail-sent">
			...
			<tr>
				...
				<td>
					<input type="button" class="send btn" value="<?php echo JText::_('SEND_EMAIL'); ?>" class="btn btn-success" style="margin-bottom:10px" />
