...
<header class="header">
	<div class="container-title">
		<h1 class="page-title"><?php echo JText::_('LEAVE_TYPES'); ?></h1>
	</div>
</header>
	...
	<table class="adminlist table">
        <thead>
            <tr>
                ...
                <th><?php echo JHTML::_('grid.sort', 'LEAVE_TYPES', 'leave_type', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
				<th><?php echo JHTML::_('grid.sort', 'NOS_LEAVES', 'leave_number', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
				<th width="10" class="hidden-phone"><?php echo JHTML::_('grid.sort', 'ID', 'id', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
            </tr>
        </thead>
        <?php
        $k = 0;
        for ($i=0, $n=count( $this->items ); $i < $n; $i++)	{
            ...
            $link 		= JRoute::_( 'index.php?option=com_vbizz&view=leaves&task=edit&cid[]='. $row->id );
            ?>
            <tr class="<?php echo "row$k"; ?>">
                ...
                <td align="center">
                    <?php if ($editaccess) : ?>
                        <a href="<?php echo $link; ?>"><?php echo $row->leave_type; ?></a>
                    <?php else : ?>
                        <?php echo $row->leave_type; ?>
                    <?php endif; ?>
                </td>
				
				<td class="lev_nmbr"><?php echo $row->leave_number; ?></td>
