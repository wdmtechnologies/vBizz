...
<header class="header">
	<div class="container-title">
		<h1 class="page-title"><?php echo JText::_('EXPORT_TASK'); ?></h1>
	</div>
</header>
...
<table class="adminlist table">
    ...
    for ($i=0, $n=count( $this->items ); $i < $n; $i++)	{
		...
		$link 		= JRoute::_( 'index.php?option=com_vbizz&view=exptask&task=edit&cid[]='.$row->id );
    ?>
        <tr class="<?php echo "row$k"; ?>">
            ...
            <td>
				<?php if ($editaccess) : ?>
                <a href="<?php echo $link; ?>"><?php echo $row->folder_path; ?></a>
                <?php else : ?>
                <?php echo $row->folder_path; ?>
                <?php endif; ?>
            </td>
