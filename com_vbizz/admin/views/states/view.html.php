...
class VbizzViewStates extends JViewLegacy
{
	function display($tpl = null)
	{
		...
		if($layout == 'edit')	{
			...
			$this->states = $this->get('Item');
			$isNew		= ($this->states->id < 1);
			$this->countries = $this->get('Countries');	

			$text = $isNew ? JText::_( 'NEW' ) : JText::_( 'EDIT' );
			JToolBarHelper::title(   JText::_( 'STATE' ).': <small><small>[ ' . $text.' ]</small></small>', 'flag.png' );
			...
			JToolBarHelper::title(   JText::_( 'STATES' ), 'flag.png' );
