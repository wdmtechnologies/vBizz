...
public class CustomDateTimePicker implements View.OnClickListener {
    ...
    public View getDateTimePickerLayout() {
        ...
        btn_setDate.setBackgroundColor(android.R.color.transparent);
        ...
        btn_setTime.setBackgroundColor(android.R.color.transparent);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case SET_DATE:
                ...
                btn_setDate.setBackgroundColor(Color.parseColor("#EA4C35"));
                btn_setTime.setBackgroundColor(android.R.color.transparent);
            ...
            case SET_TIME:
                ...
                btn_setTime.setBackgroundColor(Color.parseColor("#EA4C35"));
                btn_setDate.setBackgroundColor(android.R.color.transparent);
