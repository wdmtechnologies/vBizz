...
$db=JFactory::getDbo();
$query = ' SELECT profile_pic from #__vbizz_users WHERE userid = '.$user->id;
		$db->setQuery( $query );
		$profile_pic = $db->loadResult();
		if($profile_pic==""){
			$profile_pic = 'avtar.png';
		}
?>
<div id="btl">
	<!-- Panel top -->	
	<div class="btl-panel">
		<?php if($type == 'logout') : ?>
		<!-- Profile button -->
		<span class="btl_avtar"><?php echo '<img src="'.JURI::root().'components/com_vbizz/uploads/profile_pics/'.(!empty($profile_pic)?$profile_pic:'noimage.png').'" />' ?></span><span id="btl-panel-profile" class="btl-dropdown">
	...
	<div id="btl-content">
		...
		<div id="btl-content-profile" class="btl-content-block">
			...
			<div class="btl-buttonsubmit">
				...
				<div class="usr_inf">
				<a href="index.php?option=com_vbizz&view=vbizz" class="dashboard"><i class="fa fa-th-large"></i> <?php echo JText::_('Dashboard'); ?></a>
				<a href="index.php?option=com_vbizz&view=users" class="edit_profile"><i class="fa fa-user"></i> <?php echo JText::_('Edit Profile'); ?></a>
				<a href="index.php?option=com_vbizz&view=users" class="change_password"><i class="fa fa-pencil"></i> <?php echo JText::_('Change Password'); ?></a></div>
					<button name="Submit" class="btl-buttonsubmit" onclick="document.logoutForm.submit();"><i class="fa fa-power-off"></i> <?php echo JText::_('JLOGOUT'); ?></button>
		...
		<div id="btl-content-login" class="btl-content-block">
			...
			<form name="btl-formlogin" class="btl-formlogin" action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post">
				...
				<div class="btl-field">
					<div class="btl-label"><?php echo JText::_('MOD_VBIZZ_LOGIN_USERNAME') ?></div>
					<div class="btl-input">
						<input id="btl-input-username" type="text" name="username"	/>
					</div>
				</div>
				<div class="btl-field">
					<div class="btl-label"><?php echo JText::_('MOD_VBIZZ_LOGIN_PASSWORD') ?></div>
					<div class="btl-input">
		...
		<div id="btl-content-registration" class="btl-content-block">			
			...
			<?php if($integrated_com==''){?>	
				...
				<form name="btl-formregistration" class="btl-formregistration"  autocomplete="off">
					...
					<div class="btl-field">
						<div class="btl-label"><?php echo JText::_( 'MOD_VBIZZ_LOGIN_NAME' ); ?></div>
						<div class="btl-input">
					...
					<div class="btl-field">
						<div class="btl-label"><?php echo JText::_( 'MOD_VBIZZ_VERIFY_PASSWORD' ); ?></div>
						<div class="btl-input">
					...
					<div class="btl-field">
						<div class="btl-label"><?php echo JText::_( 'MOD_VBIZZ_EMAIL' ); ?></div>
						<div class="btl-input">
					...
					<div class="clear"></div>
					<div class="btl-field">
						<div class="btl-label"><?php echo JText::_( 'MOD_VBIZZ_VERIFY_EMAIL' ); ?></div>
						<div class="btl-input">
					...
					<div class="btl-field">
						<div class="btl-label"><?php echo JText::_( 'MOD_VBIZZ_CAPTCHA' ); ?></div>
